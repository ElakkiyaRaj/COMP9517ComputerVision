...
Integrated  task 1 and task 3
Integrating Edistance and kalman filter - done - AB test pending
Integrated task 2
Integrated seq PhC-C2DL-PSC,Fluo-N2DL-HeLa

Compile the code by typing the following in the terminal.

Task 1:
------
python CombinedCellTracker_V_2.py --seq PhC-C2DL-PSC --dt 8 --sv 0.5 --mv 1 --bias 100 --max 0 --type .tif --tracker KF --mito 5--task 1
python CombinedCellTracker_V_2.py --seq PhC-C2DL-PSC --dt 8 --sv 0.5 --mv 1 --bias 100 --max 0 --type .tif --tracker centroid --mito 5--task 1

python CombinedCellTracker_V_2.py --seq Fluo-N2DL-HeLa --dt 8 --sv 0.5 --mv 1 --bias 100 --max 0 --type .tif --tracker KF --mito 5 --task 1
python CombinedCellTracker_V_2.py --seq Fluo-N2DL-HeLa --dt 8 --sv 0.5 --mv 1 --bias 100 --max 0 --type .tif --tracker centroid --mito 5 --task 1

Task 2:
------
python CombinedCellTracker_V_2.py --seq PhC-C2DL-PSC --dt 8 --sv 0.5 --mv 1 --bias 100 --max 0 --type .tif --tracker centroid --mito 5 --task 2
python CombinedCellTracker_V_2.py --seq Fluo-N2DL-HeLa --dt 8 --sv 0.5 --mv 1 --bias 100 --max 0 --type .tif --tracker centroid --mito 7 --task 2

Task 3:
------
python CombinedCellTracker_V_2.py --seq PhC-C2DL-PSC --dt 8 --sv 0.5 --mv 1 --bias 100 --max 0 --type .tif --task 3
python CombinedCellTracker_V_2.py --seq Fluo-N2DL-HeLa --dt 8 --sv 0.5 --mv 1 --bias 100 --max 0 --type .tif --task 3
...
if __name__ == '__main__':
    ...
    while sequence.isOpened():
        ...
        for label in np.unique(labels):
            ...
            if cv2.contourArea(contour_max) > 50:
